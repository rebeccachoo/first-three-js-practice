  ...
  return (
    ...
    >
      <Box sx={{ width: "80%" }}>
        ...
        <h2>Log Files</h2>
        <p>
          ReadPoem follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertising partners of ReadPoem.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on ReadPoem, which are sent
        ...
        <p>
          Note that ReadPoem has no access to or control over these cookies that
        ...
        <p>
          ReadPoem's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ReadPoem does not knowingly collect any Personal Identifiable
