    ...
    <Box sx={{ px: 10, backgroundColor: "#002233", py: 10 }}>
      <Grid container>
        ...
        >
          ...
          <Box sx={{ pt: 2 }}>
            <HashLink to="/contact#top">Contact The Developer</HashLink>
          </Box>
          <Box sx={{ pt: 2 }}>
            <HashLink to="/request#top">Request Improvements</HashLink>
          </Box>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <Box sx={{ pt: 2 }}>
            <HashLink to="/donate#top">Donate</HashLink>
          </Box>
          <Box sx={{ pt: 2 }}>
            <HashLink to="/" smooth>
              Contribute to App
        ...
        >
          ...
          <Box sx={{ pt: 2 }}>
            <HashLink to="/terms#top">Terms of Service</HashLink>
          </Box>
          <Box sx={{ pt: 2 }}>
            {" "}
